...
def openrlhf_ray_cluster_gpu_count(experiment_name, trial_name):
    return f"{USER_NAMESPACE}/{experiment_name}/{trial_name}/openrlhf_ray_cluster_gpu_count"

    
def openrlhf_command(experiment_name, trial_name):
    return f"{USER_NAMESPACE}/{experiment_name}/{trial_name}/command_for_openrlhf"
